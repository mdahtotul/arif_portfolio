...
export default function DjangoIcon({
  ...
  const [strokeColor, setStrokeColor] = useState(stroke || "#44b78b");
  const setHoverColor = () => setStrokeColor(hoverStroke || "#004d40");
  const removeHoverColor = () => setStrokeColor(stroke || "#44b78b");
